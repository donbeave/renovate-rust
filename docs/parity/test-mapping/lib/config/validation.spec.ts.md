...
| 449 | returns nested errors | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4794`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4794) |
...
| 536 | errors for all types | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4819`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4819) |
| 571 | selectors outside packagerules array trigger errors | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4851`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4851) |
| 601 | ignore packagerule nesting validation for presets | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4878`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4878) |
...
| 787 | errors if no custommanager managerfilepatterns | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4897`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4897) |
...
| 1781 | catches invalid variable name in env config option | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4127`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4127) |
| 1809 | catches env config option if configured inside a parent | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4148`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4148) |
| 1846 | catches when * or ** is combined with others patterns in a regexorglob option | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4168`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4168) |
| 1874 | catches when negative number is used for integer type | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4215`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4215) |
| 1888 | validates prpriority | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4227`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4227) |
| 1909 | errors if no bumpversion filepattern is provided | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4243`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4243) |
| 1935 | errors if no matchstrings are provided for bumpversion | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4266`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4266) |
| 1959 | allow bumpversion | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4283`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4283) |
| 1985 | returns errors for invalid options | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4300`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4300) |
| 2007 | validates hostrules.headers | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4316`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4316) |
| 2027 | errors if hostrules.headers is defined but allowedheaders is not | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4333`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4333) |
| 2051 | validates env | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4351`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4351) |
| 2066 | handles prefixed onboardingconfigfilename | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4362`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4362) |
| 2080 | allows unique onboardingconfigfilename if it is set in configfilenames | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4373`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4373) |
| 2093 | errors if env object is defined but allowedenv is empty or undefined | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4387`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4387) |
| 2112 | validates env against the allowedenv regex | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4398`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4398) |
| 2127 | validates options with different type but defaultvalue=null | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4409`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4409) |
| 2163 | binarysource=docker is deprecated | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4440`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4440) |
| 2180 | binarysource | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4453`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4453) |
| 2198 | binarysource | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4453`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4453) |
| 2215 | basedir | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4477`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4477) |
| 2231 | requireconfig | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4487`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4487) |
| 2248 | dryrun | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4499`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4499) |
| 2265 | repositorycache | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4511`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4511) |
| 2282 | onboardingconfigfilename | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4523`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4523) |
| 2298 | onboardingconfig | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4537`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4537) |
| 2325 | force | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4553`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4553) |
| 2350 | giturl | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4570`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4570) |
| 2368 | validates boolean type options | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4582`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4582) |
| 2388 | validates integer type options | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4592`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4592) |
| 2408 | validates array type options | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4602`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4602) |
| 2439 | validates object type options | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4617`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4617) |
| 2469 | warns if negative number is used for integer type | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4635`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4635) |
| 2486 | warns on invalid customenvvariables objects | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4647`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4647) |
| 2507 | validates valid customenvvariables objects | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4660`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4660) |
| 2522 | validates options with different type but defaultvalue=null | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4409`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4409) |
| 2542 | fails for missing reportpath if reporttype is "s3" | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4691`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4691) |
| 2554 | validates reportpath if reporttype is "s3" | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4699`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4699) |
| 2567 | fails for missing reportpath if reporttype is "file" | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4710`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4710) |
| 2579 | validates reportpath if reporttype is "file" | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4718`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4718) |
| 2592 | warns when registryurls is set at the top level of global config | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4729`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4729) |
| 2607 | warns when defaultregistryurls is set at the top level of global config | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4740`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4740) |
| 2622 | validates postupgradetasks.installtools tool names | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4751`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4751) |
| 2640 | rejects invalid postupgradetasks.installtools tool names | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4762`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4762) |
| 2664 | catches when * or ** is combined with others patterns in a regexorglob option | ported | [`crates/renovate-core/src/config/migrate_validate.rs:4168`](../../../../../crates/renovate-core/src/config/migrate_validate.rs#L4168) |
