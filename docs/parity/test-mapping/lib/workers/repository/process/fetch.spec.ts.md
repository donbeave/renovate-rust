...
| 211 | skips deps with empty names | pending | — |
| 238 | skips internal deps by default | pending | — |
| 261 | fetch updates for internal deps if updateinternaldeps is true | pending | — |
| 283 | throws lookup errors for onboarded repos | pending | — |
| 300 | throws lookup errors for not onboarded repos | pending | — |
| 317 | produces external host warnings for not onboarded repos | pending | — |
