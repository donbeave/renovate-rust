...
| 265 | throws if an error occurs, and we specify ignorefailure=false | ported | [`crates/renovate-core/src/exec/orchestrator.rs:416`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L416) |
| 292 | does not throw if an error occurs, but we specify ignorefailure=true | ported | [`crates/renovate-core/src/exec/orchestrator.rs:389`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L389) |
...
| 538 | can specify shell=false | ported | [`crates/renovate-core/src/exec/orchestrator.rs:365`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L365) |
