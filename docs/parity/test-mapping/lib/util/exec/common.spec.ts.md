...
**15/30 in-scope tests ported** (15 pending, 0 opt-out) · status: partial
...
| 265 | throws if an error occurs, and we specify ignorefailure=false | ported | [`crates/renovate-core/src/exec/orchestrator.rs:332`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L332) |
| 292 | does not throw if an error occurs, but we specify ignorefailure=true | ported | [`crates/renovate-core/src/exec/orchestrator.rs:314`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L314) |
