...
| 985 | throws when an error is thrown | ported | [`crates/renovate-core/src/exec/orchestrator.rs:279`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L279) |
| 995 | rejects and throws if an error is thrown, even if we specify ignorefailure=true | pending | — |
| 1010 | does not reject and throw if rawexec returns an exit code, and we specify ignorefailure=true | ported | [`crates/renovate-core/src/exec/orchestrator.rs:317`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L317) |
...
| 1076 | supports binarysource=install | ported | [`crates/renovate-core/src/exec/orchestrator.rs:217`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L217) |
| 1087 | logs ignored tool constraints for binarysource=global | ported | [`crates/renovate-core/src/exec/orchestrator.rs:353`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L353) |
| 1098 | supports binarysource=install precommands | ported | [`crates/renovate-core/src/exec/orchestrator.rs:294`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L294) |
| 1112 | only calls removedockercontainer in catch block is usedocker is set | ported | [`crates/renovate-core/src/exec/orchestrator.rs:375`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L375) |
| 1127 | wraps error if removedockercontainer throws an error | pending | — |
| 1161 | converts to temporary_error | ported | [`crates/renovate-core/src/exec/orchestrator.rs:389`](../../../../../../crates/renovate-core/src/exec/orchestrator.rs#L389) |
