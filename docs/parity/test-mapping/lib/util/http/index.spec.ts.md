...
|--:|---|---|---|
| 37 | sets default user-agent | ported | `crates/renovate-core/src/http.rs:1034` |
...
| 101 | preserves existing headers | ported | `crates/renovate-core/src/http.rs:1049` |
| 111 | get | ported | `crates/renovate-core/src/http.rs:902` |
| 122 | returns 429 error | ported | `crates/renovate-core/src/http.rs:923` |
| 130 | returns 401 error | ported | `crates/renovate-core/src/http.rs:938` |
...
| 209 | getjson | ported | `crates/renovate-core/src/http.rs:852` |
| 233 | postjson | ported | `crates/renovate-core/src/http.rs:887` |
| 248 | putjson | ported | `crates/renovate-core/src/http.rs:967` |
| 263 | patchjson | ported | `crates/renovate-core/src/http.rs:984` |
| 278 | deletejson | ported | `crates/renovate-core/src/http.rs:1001` |
| 293 | headjson | ported | `crates/renovate-core/src/http.rs:1018` |
| 308 | stream | pending | — |
| 333 | disables hosts for stream | pending | — |
| 341 | limits concurrency by host | pending | — |
| 431 | getbuffer | pending | — |
| 451 | works | pending | — |
| 484 | gets plain text with correct headers | ported | `crates/renovate-core/src/http.rs:869` |
| 494 | works with custom options | pending | — |
| 509 | parses yaml response without schema | ported | `crates/renovate-core/src/http.rs:1069` |
| 516 | parses yaml with options | pending | — |
| 529 | throws on invalid yaml | ported | `crates/renovate-core/src/http.rs:1085` |
...
| 569 | throws on invalid yaml | ported | `crates/renovate-core/src/http.rs:1085` |
| 579 | returns successful result with schema validation | pending | — |
| 590 | returns schema error result | pending | — |
| 604 | returns error result for invalid yaml | ported | `crates/renovate-core/src/http.rs:1100` |
| 615 | returns error result for network errors | ported | `crates/renovate-core/src/http.rs:1115` |
...
| 793 | parses toml with schema validation | ported | `crates/renovate-core/src/http.rs:1145` |
| 800 | parses toml with options and schema | pending | — |
| 819 | throws on schema validation failure | pending | — |
| 834 | throws on invalid toml | ported | `crates/renovate-core/src/http.rs:1130` |
