...
| 341 | returns empty if no deps | ported | `crates/renovate-core/src/extractors/npm.rs:3799` |
| 349 | handles empty catalog entries | ported | `crates/renovate-core/src/extractors/npm.rs:3807` |
| 360 | parses valid pnpm-workspace.yaml file | ported | `crates/renovate-core/src/extractors/npm.rs:3815` |
| 395 | parses overrides in pnpm-workspace.yaml file | ported | `crates/renovate-core/src/extractors/npm.rs:3863` |
| 466 | finds relevant lockfile | ported | `crates/renovate-core/src/extractors/npm.rs:3899` |
