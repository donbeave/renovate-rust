...
|--:|---|---|---|
| 10 | is artifactory server invalid | ported | `crates/renovate-core/src/util.rs:7982` |
| 19 | is artifactory server valid | ported | `crates/renovate-core/src/util.rs:7991` |
