...
| `lib/modules/versioning/composer/index.ts` | `crates/renovate-core/src/versioning/composer.rs` | partial | getMajor/Minor/Patch, equals, isGreaterThan, isSingleVersion, isStable, isValid, isVersion, isLessThanRange, get/minSatisfyingVersion, sortVersions, isCompatible ported; Missing: matches, subset, intersects, getNewValue, isBreaking |
