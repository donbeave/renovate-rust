...
| `lib/workers/global/config/parse/cli.ts` | `crates/renovate-cli/src/cli.rs` | partial | CLI arg parsing ported, including enabled/automerge booleans |
| `lib/workers/global/config/parse/env.ts` | `crates/renovate-cli/src/config_env.rs` | partial | Env config parsing partially ported, including renamed env vars, converted experimental vars, repositories, enabled/automerge booleans, onboardingConfig, allowCommandTemplating, and forkProcessing |
