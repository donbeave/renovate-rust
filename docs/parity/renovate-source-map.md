...
| `lib/modules/manager/github-actions/parse.ts` | `crates/renovate-core/src/extractors/github_actions.rs` | partial | `parseActionReference` ported; remaining line/comment helpers partially inlined |
