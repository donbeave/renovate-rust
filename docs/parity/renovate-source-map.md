...
| `lib/workers/repository/update/pr/body/updates-table.ts` | `crates/renovate-core/src/branch.rs` | stub | `get_pr_updates_table` stub returns empty string; full implementation requires Handlebars template engine. |
