...
| `lib/modules/manager/github-actions/parse.ts` | `crates/renovate-core/src/extractors/github_actions.rs` | partial | `parseActionReference` and `parseComment` ported; remaining line helpers partially inlined |
