...
| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| should return 1.23.7 and release version | 5 | not-applicable | — | — | Renovate's AWS EKS add-on versioning scheme is not implemented as a Rust versioning API. |
| isValid("$input") === $expected | 13 | not-applicable | — | — | Renovate's AWS EKS add-on version validation is not implemented as a Rust versioning API. |
| isValid("$input") === $expected | 41 | not-applicable | — | — | Renovate's AWS EKS add-on version classifier is not implemented as a Rust versioning API. |
| isCompatible("$input") === $expected | 67 | not-applicable | — | — | Renovate's AWS EKS add-on compatibility helper is not implemented as a Rust versioning API. |
| isCompatible($version, $current) === $expected | 91 | not-applicable | — | — | Renovate's AWS EKS add-on range compatibility helper is not implemented as a Rust versioning API. |
| isGreaterThan($version, $other) === $expected | 110 | not-applicable | — | — | Renovate's AWS EKS add-on comparator is not implemented as a Rust versioning API. |
| getSatisfyingVersion | 129 | not-applicable | — | — | Renovate's AWS EKS add-on satisfying-version helper is not implemented as a Rust versioning API. |
...
| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| isValid("$input") === $expected | 4 | not-applicable | — | — | Renovate's Perl versioning scheme is not implemented as a Rust versioning API; Rust Perl support is manager/extractor oriented. |
| isStable("$input") === $expected | 29 | not-applicable | — | — | Renovate's Perl stability classifier is not implemented as a Rust versioning API; Rust Perl support is manager/extractor oriented. |
| equals($a, $b) === $expected | 43 | not-applicable | — | — | Renovate's Perl comparator is not implemented as a Rust versioning API; Rust Perl support is manager/extractor oriented. |
| isGreaterThan($a, $b) === $expected | 57 | not-applicable | — | — | Renovate's Perl comparator is not implemented as a Rust versioning API; Rust Perl support is manager/extractor oriented. |
...
**Reference:** https://github.com/renovatebot/renovate/blob/main/lib/modules/versioning/semver/common.spec.ts
**Total tests:** 1 | **Ported:** 0 | **Actionable:** 0 | **Status:** not-applicable

### `modules/versioning/semver/common`

| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| isSemVerXRange("range") === $expected | 4 | not-applicable | — | — | Renovate's SemVer x-range helper is not implemented as a Rust API; Rust currently exposes narrower generic semver update-summary helpers. |
