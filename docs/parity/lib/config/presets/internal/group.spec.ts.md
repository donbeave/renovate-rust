...
|---|---|---|---|---|---|
| group:%s contains packageRules | 10 | not-applicable | — | — | TS-library-specific schema internals — validates TypeScript internal preset definitions; Rust uses different config system without these hardcoded preset definitions |
