...
|---|---|---|---|---|---|
| should throw if no package | 10 | pending | — | — | —|
| should throw if no renovate-config | 17 | pending | — | — | —|
| should throw if preset name not found | 48 | pending | — | — | —|
| should return preset | 83 | pending | — | — | —|
