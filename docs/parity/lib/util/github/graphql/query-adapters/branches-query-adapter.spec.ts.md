...
|---|---|---|---|---|---|
| transforms Commit type | 5 | ported | `github.rs` | `transform_github_branch_commit_type_returns_item` | — |
| returns null for invalid input | 23 | ported | `github.rs` | `transform_github_branch_non_commit_type_returns_none` | — |
