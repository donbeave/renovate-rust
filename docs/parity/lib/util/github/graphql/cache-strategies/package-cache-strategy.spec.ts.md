...
**Total tests:** 1 | **Ported:** 0 | **Actionable:** 1 | **Status:** not-applicable-applicable-applicable

### `util/github/graphql/cache-strategies/package-cache-strategy`

| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| reconciles old cache record with new items | 24 | not-applicable | — | — | TypeScript Luxon + cache mock; Settings.now time mocking + vi.spyOn(packageCache) cache spy|
