...
**Total tests:** 10 | **Ported:** 6 | **Actionable:** 10 | **Status:** partial
...
| return false on version exception | 22 | pending | — | — | — |
...
| return true for same-major verisioning if version lies in expected range | 120 | pending | — | — | — |
| return false for same-major verisioning if version lies outside of expected range | 133 | pending | — | — | — |
