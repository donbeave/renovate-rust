...
**Total tests:** 5 | **Ported:** 4 | **Actionable:** 4 | **Status:** done
...
| logs unknown command for "renovate:" comments without "ignore" | 21 | not-applicable | — | — | Verifies logger.debug call which requires log mocking; not testable in Rust unit tests |
