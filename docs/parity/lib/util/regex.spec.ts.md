...
| caches non-stateful regex | 18 | not-applicable | — | — | TypeScript type-system test; checks JavaScript reference identity (toBe) of cached RE2 objects — reference equality has no Rust equivalent |
