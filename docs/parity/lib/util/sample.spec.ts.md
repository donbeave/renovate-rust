...
| returns full array for null number | 16 | not-applicable | — | — | TypeScript type-system test; null vs undefined distinction has no Rust equivalent (both are None) |
| returns full array for 0 number | 20 | ported | `util.rs` | `test_sample_size_zero_n` | — |
| returns empty array for null array | 24 | not-applicable | — | — | TypeScript type-system test; null vs undefined distinction has no Rust equivalent (both are None) |
