...
| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| works without throttling | 679 | pending | — | — | Throttling not implemented in Rust HTTP client |
| limits request rate by host | 691 | pending | — | — | Throttling not implemented in Rust HTTP client |
