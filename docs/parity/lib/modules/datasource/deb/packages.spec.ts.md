...
|---|---|---|---|---|---|
| should ignore error when fetching the InRelease content fails | 67 | pending | — | — | — |
| should throw error when checksum validation fails | 93 | pending | — | — | — |
| should throw error for when extracting fails | 108 | pending | — | — | — |
