...
| returns digest for HEAD with authentication environment variables | 94 | pending | — | — | datasource subprocess integration still partial; helper coverage exists in `crates/renovate-core/src/util.rs` |
| returns digest for HEAD with authentication environment variables for datasource type git-tags | 121 | pending | — | — | datasource subprocess integration still partial; helper coverage exists in `crates/renovate-core/src/util.rs` |
