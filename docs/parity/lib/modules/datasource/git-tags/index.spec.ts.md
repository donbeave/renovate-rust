...
| returns digest for HEAD with authentication environment variables for datasource type git-tags | 121 | not-applicable | — | — | mocking framework internals — tests TypeScript mock infrastructure |
