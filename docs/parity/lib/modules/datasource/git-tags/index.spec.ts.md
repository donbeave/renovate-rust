...
**Total tests:** 8 | **Ported:** 6 | **Actionable:** 8 | **Status:** done
...
| returns digest for HEAD with authentication environment variables | 94 | not-applicable | — | — | mocks TypeScript-internal simpleGit infrastructure |
| returns digest for HEAD with authentication environment variables for datasource type git-tags | 121 | not-applicable | — | — | mocks TypeScript-internal simpleGit infrastructure |
