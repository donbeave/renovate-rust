...
**Total tests:** 4 | **Ported:** 3 | **Actionable:** 4 | **Status:** done
...
| return null with empty registryUrl | 19 | not-applicable | — | — | Framework validates registryUrl before calling datasource |
