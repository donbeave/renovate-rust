...
| uses proper hostType | 31 | not-applicable | — | — | TypeScript OOP class structure test; checks SbtPluginDatasource class instance property http.hostType — Rust uses function-based API without OOP class hierarchy |
