...
**Total tests:** 11 | **Ported:** 9 | **Actionable:** 9 | **Status:** done
...
| returns null on missing registryUrl | 80 | not-applicable | — | — | caller responsibility; no registryUrl → caller returns null |
...
| returns null on missing registryUrl | 211 | not-applicable | — | — | caller responsibility |
