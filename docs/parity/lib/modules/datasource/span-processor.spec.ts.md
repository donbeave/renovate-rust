...
|---|---|---|---|---|---|
| creates an instance | 16 | pending | — | — | —|
| writes span datapoints to GetDatasourceReleasesStats | 24 | pending | — | — | —|
| defaults registryUrl to an empty string if not provided | 50 | pending | — | — | —|
| $name | 128 | pending | — | — | —|
