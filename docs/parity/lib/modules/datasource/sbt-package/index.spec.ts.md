...
**Total tests:** 13 | **Ported:** 10 | **Actionable:** 13 | **Status:** done
...
| uses proper hostType | 32 | not-applicable | — | — | TypeScript class property test; no equivalent concept in Rust |
...
| continues when parseUrl returns null for packageRootUrl | 284 | not-applicable | — | — | vi.spyOn(urlUtil, 'parseUrl') mock infrastructure |
| skips pkgUrl when parseUrl returns null for it | 322 | not-applicable | — | — | vi.spyOn(urlUtil, 'parseUrl') mock infrastructure |
