...
|---|---|---|---|---|---|
| returns tags from azure devops | 20 | pending | — | — | — |
| filters out undefined names | 47 | pending | — | — | — |
| handles api errors | 70 | pending | — | — | — |

### `modules/datasource/azure-tags/index › static methods`

| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| getCacheKey returns the expected format | 83 | pending | — | — | — |
| getSourceUrl returns the correct URL format | 92 | pending | — | — | — |
