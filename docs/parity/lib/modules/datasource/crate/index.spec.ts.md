...
**Total tests:** 27 | **Ported:** 16 | **Actionable:** 11 | **Status:** done
...
| clones once then reuses the cache | 389 | not-applicable | — | — | Git-clone based Cargo registries not supported in Rust |
| reads config.json from cloned registry | 402 | not-applicable | — | — | Git-clone based Cargo registries not supported in Rust |
