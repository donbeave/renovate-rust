...
**Total tests:** 12 | **Ported:** 11 | **Actionable:** 12 | **Status:** done
...
| returns null for missing hash | 73 | not-applicable | — | — | REST /tags always includes commit.sha; missing-hash is GraphQL-specific |
