...
**Total tests:** 29 | **Ported:** 28 | **Actionable:** 0 | **Status:** done
...
| debug logs | 709 | not-applicable | — | — | mocking framework internals — tests logger.once.debug spy only; return-value behavior covered by sibling test 'newVersion is returned anyway' (ported) |
