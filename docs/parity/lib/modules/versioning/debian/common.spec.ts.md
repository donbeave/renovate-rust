...
**Total tests:** 5 | **Ported:** 4 | **Actionable:** 5 | **Status:** done

### `modules/versioning/debian/common`

| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| no rolling release data | 15 | not-applicable | — | — | Uses logger spy assertion (expect(logger.debug).toHaveBeenCalledTimes); not portable |
