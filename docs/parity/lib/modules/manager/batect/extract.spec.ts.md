...
| extracts all available images and bundles from a valid Batect configuration file, including dependencies in included files | 70 | ported | `batect.rs` | `extracts_git_bundles_and_file_includes` | — |
