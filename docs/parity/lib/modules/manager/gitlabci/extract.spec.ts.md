...
**Total tests:** 14 | **Ported:** 13 | **Actionable:** 13 | **Status:** ported
...
| extracts multiple included image lines | 46 | not-applicable | — | — | requires multi-file include resolution not available in unit test scope |
