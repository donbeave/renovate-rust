...
|---|---|---|---|---|---|
| returns updated files if the wrapper script is in the root directory | 54 | pending | — | — | — |
| returns updated files if the wrapper script is in a subdirectory | 76 | pending | — | — | — |
| returns an error if the updated wrapper script cannot be downloaded | 98 | pending | — | — | — |
