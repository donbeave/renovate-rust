...
|---|---|---|---|---|---|
| validate manager hash | 5 | not-applicable | — | — | TS module system — iterates allManagersList and checks hashMap (SHA-256 of manager source); no Rust equivalent of dynamic source hashing |
