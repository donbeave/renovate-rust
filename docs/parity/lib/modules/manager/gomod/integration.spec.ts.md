...
|---|---|---|---|---|---|
| only suggests updates within the minor version of the `go` directive | 21 | not-applicable | — | — | tests gomod integration via real 'go' command execution; external tool invocation out of scope |
