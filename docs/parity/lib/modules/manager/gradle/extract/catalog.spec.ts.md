...
| deletes commit message for plugins with version reference | 134 | ported | `extractors/gradle.rs` | `catalog_plugin_version_ref_deletes_commit_message` | — |
...
| changes the dependency version, not the comment version | 203 | ported | `extractors/gradle.rs` | `catalog_version_position_ignores_comments` | — |
| supports templated toml | 254 | ported | `extractors/gradle.rs` | `catalog_templated_toml` | — |
