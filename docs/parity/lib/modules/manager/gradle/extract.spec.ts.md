...
**Total tests:** 31 | **Ported:** 14 | **Actionable:** 31 | **Status:** partial
...
| logs a warning in case parseGradle throws an exception | 52 | pending | — | — | Requires extractAllPackageFiles orchestration |
...
| resolves cross-file Kotlin objects | 191 | pending | — | — | Requires extractAllPackageFiles orchestration with Kotlin source parsing |
| inherits gradle variables | 311 | pending | — | — | Requires extractAllPackageFiles orchestration with variable inheritance |
...
| interpolates registry URLs | 451 | pending | — | — | Requires extractAllPackageFiles with variable interpolation |
...
| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| extracts content descriptors | 672 | pending | — | — | Requires extractAllPackageFiles with registry URL + content descriptor extraction from build files |
...
| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| works with dependency catalogs | 889 | pending | — | — | Requires extractAllPackageFiles orchestration |
| provides versions from external version catalogs to gradle files | 1006 | pending | — | — | Requires extractAllPackageFiles orchestration |
| provides versions to gradle files with changed default catalog name | 1061 | pending | — | — | Requires extractAllPackageFiles orchestration |
| ignores version catalog accessor with non-get provider method | 1106 | pending | — | — | Requires extractAllPackageFiles orchestration |
| aligns sharedVariableName if version reference has multiple aliases | 1127 | pending | — | — | Requires extractAllPackageFiles orchestration |

### `extractPackageFile() › apply from`

| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| loads further scripts using apply from statements | 1175 | pending | — | — | Requires extractAllPackageFiles with apply-from cross-file loading |
| works with files in sub-directories | 1269 | pending | — | — | Requires extractAllPackageFiles with apply-from |
| prevents recursive apply from calls | 1304 | pending | — | — | Requires extractAllPackageFiles with apply-from recursion guard |
| prevents inclusion of non-Gradle files | 1319 | pending | — | — | Requires extractAllPackageFiles with file type filtering |

### `extractPackageFile() › gradle-consistent-versions plugin`

| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| parses versions files | 1335 | pending | — | — | Requires extractAllPackageFiles orchestration |
| plugin not used due to lockfile not a GCV lockfile | 1385 | pending | — | — | Requires extractAllPackageFiles orchestration |
| plugin not used due to lockfile missing | 1401 | pending | — | — | Requires extractAllPackageFiles orchestration |
