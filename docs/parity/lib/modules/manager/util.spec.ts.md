...
| applies git source for rev | 129 | ported | `util.rs` | `test_apply_git_source_rev` | — |
| skips git source for branch | 145 | ported | `util.rs` | `test_apply_git_source_branch` | — |
| skips git source for git only | 160 | ported | `util.rs` | `test_apply_git_source_git_only` | — |
