...
|---|---|---|---|---|---|
| handles release notes | 79 | not-applicable | — | — | Bitbucket API HTTP mocking |
| handles missing release notes | 94 | not-applicable | — | — | Bitbucket API HTTP mocking |
| handles release list | 103 | not-applicable | — | — | Bitbucket API HTTP mocking |

### `workers/repository/update/pr/changelog/bitbucket/index › source`

| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| returns api base url | 112 | not-applicable | — | — | Bitbucket API HTTP mocking |
| returns get ref comparison url | 117 | not-applicable | — | — | Bitbucket API HTTP mocking |
