...
**Total tests:** 3 | **Ported:** 1 | **Actionable:** 2 | **Status:** partial

### `workers/repository/update/pr/body/notes`

| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| renders notes  | 8 | pending | — | — | `getPrNotes` uses Handlebars template engine (`template.compile`) which is not yet ported to Rust |
| handles render error  | 25 | pending | — | — | Same reason as line 8 |
