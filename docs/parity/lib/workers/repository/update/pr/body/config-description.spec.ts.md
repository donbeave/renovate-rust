...
**Total tests:** 16 | **Ported:** 13 | **Actionable:** 0 | **Status:** done
...
| summarizes cron schedules  | 62 | not-applicable | — | — | TS-library-specific schema internals; cronstrue cron-to-human translation is a TypeScript-specific library feature |
...
| summarizes cron schedules (for automergeSchedule)  | 86 | not-applicable | — | — | TS-library-specific schema internals; cronstrue cron-to-human translation is a TypeScript-specific library feature |
| summarizes both branch creation and automerge schedules  | 97 | not-applicable | — | — | TS-library-specific schema internals; cronstrue cron-to-human translation is a TypeScript-specific library feature |
