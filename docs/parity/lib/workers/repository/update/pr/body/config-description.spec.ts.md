...
**Total tests:** 16 | **Ported:** 13 | **Actionable:** 3 | **Status:** partial
...
| summarizes cron schedules  | 62 | pending | — | — | Requires cronstrue cron-to-human translation; Rust schedule_to_string only formats raw cron expressions as backticks |
...
| summarizes cron schedules (for automergeSchedule)  | 86 | pending | — | — | Requires cronstrue cron-to-human translation; Rust schedule_to_string only formats raw cron expressions as backticks |
| summarizes both branch creation and automerge schedules  | 97 | pending | — | — | Requires cronstrue cron-to-human translation; Rust schedule_to_string only formats raw cron expressions as backticks |
