...
|---|---|---|---|---|---|
| does not process a repository, but also does not error | 24 | not-applicable | — | — | mocking framework internals — vi.mock on all worker modules; tests TypeScript module coordination returning undefined |
