...
|---|---|---|---|---|---|
| does not process a repository, but also does not error | 24 | not-applicable | — | — | tests repository worker entry point orchestration; worker orchestration out of scope |
