...
|---|---|---|---|---|---|
| filter with enabledManagers | 7 | not-applicable | — | — | tests fingerprint config extraction tied to TypeScript config infrastructure |
| filter with all managers enabled | 80 | not-applicable | — | — | tests fingerprint config extraction tied to TypeScript config infrastructure |
