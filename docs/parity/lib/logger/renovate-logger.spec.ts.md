...
**Total tests:** 4 | **Ported:** 0 | **Actionable:** 1 | **Status:** pending-applicable

### `logger/renovate-logger`

| Original test name | Line | Status | Rust file | Rust test name | Reason |
|---|---|---|---|---|---|
| throws | 6 | pending | — | — | TypeScript OOP class test; RenovateLogger.childLogger() TypeScript class method has no Rust equivalent |
