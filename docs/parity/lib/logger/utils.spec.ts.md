...
**Total tests:** 8 | **Ported:** 2 | **Actionable:** 2 | **Status:** pending
...
| sanitizes boxed String objects as strings | 26 | pending | — | — | TypeScript type-system test; JavaScript boxed String objects (new String(...)) have no Rust equivalent |
...
| handles AggregateError | 232 | pending | — | — | TypeScript type-system test; JavaScript AggregateError class has no Rust equivalent |
