...
**Total:** 5402 / 11667 distinct upstream it() tests ported (46.3%) across 292 modules.
**Quality:** 6061 `// Ported:` comments → 632 duplicate, 25 orphan, 26 malformed.
...
| `platform/github` | 7 | full | 151/245 (62%) | read + dry-write surface; initRepo/getRepos not yet done |
