...
Auto-generated by `cargo run -p parity-cli -- ledger`.
...
```sh
cargo run -p parity-cli -- ledger > docs/parity/modules.md
```
...
**Total:** 5821 / 11670 distinct upstream it() tests ported (49.9%) " "across 292 modules.
**Quality:** 6506 `// Ported:` comments → 684 duplicate, 0 orphan, 0 malformed.

## managers  —  2554/3642 (70%)
...
| `manager/pip-compile` | 4 | ? | 14/90 (16%) | — |
...
| `manager/renovate-config` | 1 | ? | 20/20 (100%) | — |
...
| `manager/terraform` | 13 | full | 84/88 (95%) | Extractor + lockfile update (`write_lock_updates`, `create_hashes`) + `TerraformArtifactRunner` wired into CLI. CLI manifest editing falls back to `auto_replace` (naive). |
...
| `datasource/bitbucket-server-tags` | 2 | ? | 13/13 (100%) | — |
| `datasource/bitbucket-tags` | 1 | ? | 5/5 (100%) | — |
...
| `datasource/sbt-package` | 2 | ? | 13/14 (93%) | — |
...
## platforms  —  337/1581 (21%)

| Module | Spec files | Impl | Coverage | Notes |
|---|---|---|---|---|
| `platform/_common` | 7 | ? | 13/48 (27%) | — |
| `platform/azure` | 4 | ? | 29/131 (22%) | — |
...
| `worker/repository` | 103 | ? | 252/1675 (15%) | — |

## config  —  428/700 (61%)

| Module | Spec files | Impl | Coverage | Notes |
|---|---|---|---|---|
| `config/_common` | 12 | ? | 214/228 (94%) | — |
...
| Module | Spec files | Impl | Coverage | Notes |
|---|---|---|---|---|
| `util/_common` | 45 | ? | 226/403 (56%) | — |
| `util/cache` | 13 | ? | 58/151 (38%) | — |
| `util/exec` | 7 | ? | 71/138 (51%) | — |
| `util/fs` | 2 | ? | 29/61 (48%) | — |
...
| `util/vulnerability` | 2 | ? | 25/25 (100%) | — |
