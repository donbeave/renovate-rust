...
**Total:** 5614 / 11670 distinct upstream it() tests ported (48.1%) across 292 modules.
**Quality:** 6324 `// Ported:` comments → 709 duplicate, 0 orphan, 0 malformed.

## managers  —  2443/3642 (67%)
...
| `manager/bazel-module` | 10 | full | 91/110 (83%) | — |
...
| `manager/bundler` | 7 | full | 59/74 (80%) | — |
...
| `manager/github-actions` | 3 | full | 80/98 (82%) | — |
...
| `manager/homebrew` | 5 | full | 52/64 (81%) | — |
...
| `manager/pip_requirements` | 4 | full | 34/36 (94%) | — |
...
| `datasource/crate` | 1 | full | 22/27 (81%) | — |
...
| `datasource/npm` | 4 | full | 52/64 (81%) | — |
...
| Module | Spec files | Impl | Coverage | Notes |
|---|---|---|---|---|
| `config/_root` | 12 | full | 213/228 (93%) | — |
...
| `util/package-rules` | 11 | full | 130/143 (91%) | — |
