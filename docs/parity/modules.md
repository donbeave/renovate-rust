...
**Total:** 5337 / 11667 distinct upstream it() tests ported (45.7%) across 292 modules.
**Quality:** 5984 `// Ported:` comments → 620 duplicate, 25 orphan, 26 malformed.
...
| `manager/npm` | 32 | full | 353/439 (80%) | — |
...
| `datasource/npm` | 4 | full | 53/64 (83%) | — |
