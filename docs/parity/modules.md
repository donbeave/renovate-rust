...
**Total:** 5111 / 11667 distinct upstream it() tests ported (43.8%) across 292 modules.
**Quality:** 5656 `// Ported:` comments → 518 duplicate, 26 orphan, 26 malformed.

## managers  —  2235/3642 (61%)
...
| `manager/npm` | 32 | partial | 199/439 (45%) | index.ts(partial); dependency.ts(partial); node.ts(partial) +33 more |
...
| `datasource/npm` | 4 | partial | 37/64 (58%) | npmrc.ts(full); get.ts(partial); schema.ts(partial) |
