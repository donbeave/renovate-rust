...
|---|---|---|---|---|---|
| validate dockerfile has consistent base image versions | 4 | not-applicable | — | — | Tests TypeScript project's Dockerfile consistency; Rust project has different Docker setup |
