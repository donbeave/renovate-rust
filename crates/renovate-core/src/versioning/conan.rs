...
//! @parity lib/modules/versioning/conan/range.ts full
//!
//! Conan versioning.
//!
...
mod tests {
    ...
    // Ported: "getNewValue("$currentValue", "$rangeStrategy", "$currentVersion", "$newVersion") === "$result"" — lib/modules/versioning/conan/index.spec.ts line 565
    ...
    // Ported: "getMajor("$version") === $major getMinor("$version") === $minor getPatch("$version") === $patch" — lib/modules/versioning/conan/index.spec.ts line 720
