...
mod tests {
    ...
    // Ported: "isVersion($input) === $expected" — versioning/exact/index.spec.ts line 18
    #[test]
    ...
    // Ported: "returns true for any valid version" — versioning/exact/index.spec.ts line 30
    #[test]
    ...
    // Ported: "returns true for any version" — versioning/exact/index.spec.ts line 38
    #[test]
    ...
    // Ported: "equals(\"$a\", \"$b\") === $expected" — versioning/exact/index.spec.ts line 66
    #[test]
    ...
    // Ported: "isGreaterThan(\"$a\", \"$b\") === $expected" — versioning/exact/index.spec.ts line 79
    #[test]
    ...
    // Ported: "matches(\"$version\", \"$range\") === $expected" — versioning/exact/index.spec.ts line 90
    #[test]
    ...
    // Ported: "returns exact match only" — versioning/exact/index.spec.ts line 106
    #[test]
    ...
    // Ported: "returns exact match only" — versioning/exact/index.spec.ts line 115
    #[test]
    ...
    // Ported: "returns currentValue unchanged" — versioning/exact/index.spec.ts line 124
    #[test]
    fn get_new_value_returns_current_value_unchanged() {
        assert_eq!(get_new_value("v1"), "v1");
    }

    // Ported: "returns 0 for any comparison" — versioning/exact/index.spec.ts line 138
    #[test]
