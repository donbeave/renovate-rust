...
mod tests {
    ...
    // Ported: "isValid($version) === $expected" — versioning/apk/index.spec.ts line 4
    #[test]
    ...
    // Ported: "isStable($version) === $expected" — versioning/apk/index.spec.ts line 18
    #[test]
    ...
    // Ported: "getMajor($version) === $expected" — versioning/apk/index.spec.ts line 35
    #[test]
    ...
    // Ported: "getMinor($version) === $expected" — versioning/apk/index.spec.ts line 44
    #[test]
    ...
    // Ported: "getPatch($version) === $expected" — versioning/apk/index.spec.ts line 53
    #[test]
    ...
    // Ported: "compare($a, $b) === $expected" — versioning/apk/index.spec.ts line 63
    #[test]
    ...
    // Ported: "isGreaterThan($a, $b) === $expected" — versioning/apk/index.spec.ts line 89
    #[test]
    ...
    // Ported: "equals($a, $b) === $expected" — versioning/apk/index.spec.ts line 100
    #[test]
    ...
    // Ported: "should return null for empty versions array" — versioning/apk/index.spec.ts line 156
    #[test]
    ...
    // Ported: "should filter out invalid versions" — versioning/apk/index.spec.ts line 160
    #[test]
    ...
    // Ported: "should return false for empty versions" — versioning/apk/index.spec.ts line 178
    #[test]
    fn is_single_version_empty_matches_renovate_apk_index_spec() {
        assert!(!is_single_version(""));
    }

    // Ported: "isLessThanRange($version, $range) === $expected" — versioning/apk/index.spec.ts line 187
    #[test]
    ...
    // Ported: "should sort versions correctly" — versioning/apk/index.spec.ts line 201
    #[test]
    ...
    // Ported: "should parse complex versions ($version) === $expected" — versioning/apk/index.spec.ts line 220
    #[test]
    ...
    // Ported: "should identify stable versions ($version) === $expected" — versioning/apk/index.spec.ts line 234
    #[test]
    ...
    // Ported: "should compare versions with prerelease identifiers ($a, $b) === $expected" — versioning/apk/index.spec.ts line 250
    #[test]
    ...
    // Ported: "should handle null/undefined inputs" — versioning/apk/index.spec.ts line 274
    #[test]
    ...
    // Ported: "should return false for unstable versions with prerelease" — versioning/apk/index.spec.ts line 284
    #[test]
    ...
    // Ported: "should return false for empty versions in isStable" — versioning/apk/index.spec.ts line 290
    #[test]
    fn error_handling_empty_is_stable_matches_renovate_apk_index_spec() {
        assert!(!is_stable(""));
    }

    // Ported: "should handle versions with different major versions in tilde range" — versioning/apk/index.spec.ts line 298
    #[test]
    ...
    // Ported: "should handle versions with prerelease identifiers in ranges" — versioning/apk/index.spec.ts line 317
    #[test]
    ...
    // Ported: "should return null for invalid versions" — versioning/apk/index.spec.ts line 333
    #[test]
    ...
    // Ported: "should return patch version for non-_p patterns" — versioning/apk/index.spec.ts line 339
    #[test]
    ...
    // Ported: "should handle versions with operators" — versioning/apk/index.spec.ts line 345
    #[test]
    ...
    // Ported: "should strip revision from newVersion when currentValue has no revision" — versioning/apk/index.spec.ts line 351
    #[test]
    fn get_new_value_strip_revision_matches_renovate_apk_index_spec() {
        assert_eq!(get_new_value("2.50.0", "2.51.1-r1"), "2.51.1");
    }

    // Ported: "should keep revision in newVersion when currentValue has revision" — versioning/apk/index.spec.ts line 360
    #[test]
    fn get_new_value_keep_revision_matches_renovate_apk_index_spec() {
        assert_eq!(get_new_value("2.50.0-r0", "2.51.1-r1"), "2.51.1-r1");
    }

    // Ported: "should handle newVersion without revision when currentValue has no revision" — versioning/apk/index.spec.ts line 369
    #[test]
    fn get_new_value_no_revision_matches_renovate_apk_index_spec() {
        assert_eq!(get_new_value("2.50.0", "2.51.1"), "2.51.1");
    }

    // Ported: "should handle newVersion without revision when currentValue has revision" — versioning/apk/index.spec.ts line 378
    #[test]
    ...
    // Ported: "should handle complex prerelease identifier comparisons" — versioning/apk/index.spec.ts line 386
    #[test]
    ...
    // Ported: "should handle versions with different prerelease patterns" — versioning/apk/index.spec.ts line 393
    #[test]
    ...
    // Ported: "should handle unknown range operators" — versioning/apk/index.spec.ts line 401
    #[test]
    ...
    // Ported: "should handle unhandled range operators that match regex" — versioning/apk/index.spec.ts line 412
    #[test]
    ...
    // Ported: "should handle tilde range with invalid target version" — versioning/apk/index.spec.ts line 421
    #[test]
    ...
    // Ported: "should handle tilde range with invalid version in list" — versioning/apk/index.spec.ts line 427
    #[test]
    ...
    // Ported: "should handle letter vs number at same position in version parts" — versioning/apk/index.spec.ts line 443
    #[test]
    ...
    // Ported: "should handle number vs letter comparison in version parts" — versioning/apk/index.spec.ts line 448
    #[test]
    ...
    // Ported: "should handle extra numeric parts in remaining segments" — versioning/apk/index.spec.ts line 453
    #[test]
    ...
    // Ported: "should handle lexicographic string comparison in version parts" — versioning/apk/index.spec.ts line 458
    #[test]
    ...
    // Ported: "should handle equal letter parts continuing to next segment" — versioning/apk/index.spec.ts line 463
    #[test]
    ...
    // Ported: "should handle trailing letter in remaining segments" — versioning/apk/index.spec.ts line 468
    #[test]
    ...
    // Ported: "should return 0 for numerically equal but string-different versions" — versioning/apk/index.spec.ts line 473
    #[test]
    fn version_comparison_numeric_equal_string_diff_matches_renovate_apk_index_spec() {
        assert_eq!(sort_versions("1.0", "1.00"), 0);
    }

    // Ported: "should handle versions with different extra segment lengths" — versioning/apk/index.spec.ts line 477
    #[test]
