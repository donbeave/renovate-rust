...
mod tests {
    ...
    // Ported: "test" — lib/modules/versioning/debian/index.spec.ts line 18
    #[test]
    fn debian_basic_test() {
        assert!(debian_is_version("1.1"));
    }

    // Ported: "isValid("$version") === $expected" — lib/modules/versioning/debian/index.spec.ts line 22
    #[test]
    ...
    // Ported: "isCompatible("$version") === $expected" — lib/modules/versioning/debian/index.spec.ts line 82
    #[test]
    ...
    // Ported: "isSingleVersion("$version") === $expected" — lib/modules/versioning/debian/index.spec.ts line 104
    #[test]
    ...
    // Ported: "isStable("$version") === $expected" — lib/modules/versioning/debian/index.spec.ts line 115
    #[test]
    ...
    // Ported: "ensures that rolling release is not refreshed within frame time window: $version" — lib/modules/versioning/debian/index.spec.ts line 169
    ...
    // Ported: "isVersion("$version") === $expected" — lib/modules/versioning/debian/index.spec.ts line 188
    #[test]
    ...
    // Ported: "getMajor, getMinor, getPatch for "$version"" — lib/modules/versioning/debian/index.spec.ts line 248
    #[test]
    ...
    // Ported: "equals($a, $b) === $expected" — lib/modules/versioning/debian/index.spec.ts line 273
    #[test]
    ...
    // Ported: "isGreaterThan("$a", "$b") === $expected" — lib/modules/versioning/debian/index.spec.ts line 297
    #[test]
    ...
    // Ported: "getSatisfyingVersion($versions, "$range") === "$expected"" — lib/modules/versioning/debian/index.spec.ts line 340
    #[test]
    ...
    // Ported: "minSatisfyingVersion($versions, "$range") === "$expected"" — lib/modules/versioning/debian/index.spec.ts line 361
    #[test]
    ...
    // Ported: "getNewValue("$currentValue", "$rangeStrategy", "$currentVersion", "$newVersion") === "$expected"" — lib/modules/versioning/debian/index.spec.ts line 383
    #[test]
    ...
    // Ported: "debian.sortVersions($a, $b) === $expected" — lib/modules/versioning/debian/index.spec.ts line 409
    #[test]
    ...
    // Ported: "matches("$version", "$range") === "$expected"" — lib/modules/versioning/debian/index.spec.ts line 429
    #[test]
    ...
    // Ported: "checks runtime date handling & refresh rolling release data" — lib/modules/versioning/debian/index.spec.ts line 441
