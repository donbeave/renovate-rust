...
mod tests {
    ...
    // Ported: "isValid(\"$version\") === $expected" — versioning/rpm/index.spec.ts line 3
    #[test]
    ...
    // Ported: "isGreaterThan(\"$a\", \"$b\") === $expected" — versioning/rpm/index.spec.ts line 96
    #[test]
    ...
    // Ported: "getMajor(\"$version\") === $expected" — versioning/rpm/index.spec.ts line 154
    #[test]
    ...
    // Ported: "getMinor(\"$version\") === $expected" — versioning/rpm/index.spec.ts line 168
    #[test]
    ...
    // Ported: "getPatch(\"$version\") === $expected" — versioning/rpm/index.spec.ts line 182
    #[test]
