...
"#;
    ...
    // Ported: "returns results" — lib/modules/manager/meteor/extract.spec.ts line 13
    #[test]
    fn extracts_deps() {
    ...
    // Ported: "returns empty if fails to parse" — lib/modules/manager/meteor/extract.spec.ts line 8
    #[test]
