...
"#;
    ...
    // Ported: "load and parse successfully" — lib/modules/manager/pub/utils.spec.ts line 14
    #[test]
    ...
    // Ported: "invalid yaml" — lib/modules/manager/pub/utils.spec.ts line 32
    #[test]
    ...
    // Ported: "invalid schema" — lib/modules/manager/pub/utils.spec.ts line 37
    #[test]
    ...
    // Ported: "load and parse successfully" — lib/modules/manager/pub/utils.spec.ts line 44
    #[test]
    ...
    // Ported: "invalid yaml" — lib/modules/manager/pub/utils.spec.ts line 56
    #[test]
    ...
    // Ported: "invalid schema" — lib/modules/manager/pub/utils.spec.ts line 61
    #[test]
    ...
    // Ported: "returns null for invalid pubspec file" — lib/modules/manager/pub/extract.spec.ts line 8
    #[test]
    ...
    // Ported: "returns dart sdk only" — lib/modules/manager/pub/extract.spec.ts line 16
    #[test]
    ...
    // Ported: "returns valid dependencies" — lib/modules/manager/pub/extract.spec.ts line 33
    #[test]
