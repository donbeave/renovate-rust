...
"#;
    ...
    // Ported: "returns empty list for an empty yaml file" — lib/modules/manager/jenkins/extract.spec.ts line 19
    #[test]
    fn yml_empty_returns_empty() {
        assert!(extract_yml("").is_empty());
    }

    // Ported: "returns empty list for an empty text file" — lib/modules/manager/jenkins/extract.spec.ts line 14
    #[test]
    fn txt_empty_file_returns_empty() {
        assert!(extract_txt("").is_empty());
    }

    // Ported: "returns empty list for an invalid yaml file" — lib/modules/manager/jenkins/extract.spec.ts line 24
    #[test]
    ...
    // Ported: "extracts multiple image lines in text format" — lib/modules/manager/jenkins/extract.spec.ts line 29
    #[test]
    ...
    // Ported: "extracts multiple image lines in yaml format" — lib/modules/manager/jenkins/extract.spec.ts line 35
    #[test]
