...
mod tests {
    ...
    // Ported: "returns null for unsupported registryUrl" — lib/modules/datasource/bitrise/index.spec.ts line 9
    #[tokio::test]
    ...
    // Ported: "support GitHub Enterprise API URL" — lib/modules/datasource/bitrise/index.spec.ts line 19
    #[tokio::test]
    ...
    // Ported: "returns version and filters out the asset folder" — lib/modules/datasource/bitrise/index.spec.ts line 63
    #[tokio::test]
    ...
    // Ported: "returns null if there are no releases" — lib/modules/datasource/bitrise/index.spec.ts line 137
    #[tokio::test]
    ...
    // Ported: "returns null if the package has an unexpected format" — lib/modules/datasource/bitrise/index.spec.ts line 159
    #[tokio::test]
    ...
    // Ported: "returns null if the file object has no content" — lib/modules/datasource/bitrise/index.spec.ts line 179
    #[tokio::test]
    ...
    // Ported: "returns null if the file object has an unexpected encoding" — lib/modules/datasource/bitrise/index.spec.ts line 206
    #[tokio::test]
