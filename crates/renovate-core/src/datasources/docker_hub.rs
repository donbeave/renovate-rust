...
mod tests {
    ...
    // Ported: "adds library/ prefix for Docker Hub (implicit)" — lib/modules/datasource/docker/index.spec.ts line 2228
    #[test]
    ...
    // Ported: "findLatestStable works" — lib/modules/datasource/docker/common.spec.ts line 279
    #[test]
    ...
    // Ported: "Uses Docker Hub tags for registry-1.docker.io" — lib/modules/datasource/docker/index.spec.ts line 2132
    #[tokio::test]
    ...
    // Ported: "strips trailing slash from registry" — lib/modules/datasource/docker/index.spec.ts line 2394
    #[tokio::test]
