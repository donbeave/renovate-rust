...
mod tests {
    ...
    // Ported: "should handle error response on versions request" — datasource/glasskube-packages/index.spec.ts line 29
    #[tokio::test]
    ...
    // Ported: "should handle error response on manifest request" — datasource/glasskube-packages/index.spec.ts line 51
    #[tokio::test]
    ...
    // Ported: "should handle empty response on manifest request" — datasource/glasskube-packages/index.spec.ts line 67
    #[tokio::test]
    ...
    // Ported: "should handle package manifest without references" — datasource/glasskube-packages/index.spec.ts line 81
    #[tokio::test]
    ...
    // Ported: "should handle package manifest with references and default url" — datasource/glasskube-packages/index.spec.ts line 100
    #[tokio::test]
