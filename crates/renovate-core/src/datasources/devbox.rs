...
mod tests {
    ...
    // Ported: "throws for error" — datasource/devbox/index.spec.ts line 31
    #[tokio::test]
    ...
    // Ported: "returns null for 404" — datasource/devbox/index.spec.ts line 40
    #[tokio::test]
    ...
    // Ported: "returns null for empty result" — datasource/devbox/index.spec.ts line 49
    #[tokio::test]
    ...
    // Ported: "returns null for empty 200 OK" — datasource/devbox/index.spec.ts line 60
    #[tokio::test]
    ...
    // Ported: "throws for 5xx" — datasource/devbox/index.spec.ts line 72
    #[tokio::test]
    ...
    // Ported: "processes real data" — datasource/devbox/index.spec.ts line 83
    #[tokio::test]
