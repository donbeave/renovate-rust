...
mod tests {
    ...
    // Ported: "processes real data" — elm-package/index.spec.ts line 80
    #[test]
    ...
    // Ported: "returns null for empty result" — elm-package/index.spec.ts line 21
    #[test]
    ...
    // Ported: "returns null for invalid schema response" — elm-package/index.spec.ts line 114
    #[test]
    ...
    // Ported: "handles package without slash in name" — elm-package/index.spec.ts line 122
    #[test]
