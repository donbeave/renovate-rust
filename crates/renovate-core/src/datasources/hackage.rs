...
mod tests {
    ...
    // Ported: "should make release with given version" — lib/modules/datasource/hackage/index.spec.ts line 9
    #[test]
    ...
    // Ported: "returns null for 404" — lib/modules/datasource/hackage/index.spec.ts line 26
    #[tokio::test]
    ...
    // Ported: "returns releases for 200" — lib/modules/datasource/hackage/index.spec.ts line 36
    #[tokio::test]
    ...
    // Ported: "return null with empty registryUrl" — lib/modules/datasource/hackage/index.spec.ts line 17
    #[tokio::test]
