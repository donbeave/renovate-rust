...
mod tests {
    ...
    // Ported: "returns null for empty result" — galaxy/index.spec.ts line 11
    #[tokio::test]
    ...
    // Ported: "returns null for missing fields" — galaxy/index.spec.ts line 24
    #[tokio::test]
    ...
    // Ported: "returns null for empty list" — galaxy/index.spec.ts line 37
    #[tokio::test]
    ...
    // Ported: "returns null for 404" (username only) — galaxy/index.spec.ts line 50
    #[tokio::test]
