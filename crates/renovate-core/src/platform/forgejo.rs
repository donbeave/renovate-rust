//! Forgejo platform client.
//!
//! Implements [`PlatformClient`] against the Forgejo REST API v1.
//!
//! Renovate reference: `lib/modules/platform/forgejo/index.ts`.
//!
//! ## Authentication
//!
...
impl ForgejoClient {
    ...
    pub fn with_endpoint(
        ...
        let api_base = format!("{server}/{FORGEJO_API_VERSION}");
        Ok(Self {
...
pub async fn list_prs(
    ...
    repo: &str,
    state: Option<&str>,
) -> Result<Vec<ForgejoPr>, PlatformError> {
...
pub async fn add_comment(
    ...
    pr_id: i64,
    text: &str,
) -> Result<ForgejoComment, PlatformError> {
    let url = format!(
    ...
    client
        .http
        .post_json::<ForgejoComment>(&url, &request_json)
        .await
        .map_err(PlatformError::Http)
}
...
impl PlatformClient for ForgejoClient {
    ...
    async fn get_branch_status(
        ...
        Err(PlatformError::NotSupported(
            "Forgejo branch status not yet implemented".to_owned(),
        ))
    }
    ...
    async fn write_file(
        ...
        Err(PlatformError::NotSupported(
            "Forgejo write_file not yet implemented".to_owned(),
        ))
    }
    ...
    async fn get_pr_list(
        ...
        Err(PlatformError::NotSupported("Forgejo PR list".to_owned()))
    }
    ...
    async fn get_pr(
        ...
        Err(PlatformError::NotSupported("Forgejo get PR".to_owned()))
    }
...
mod tests {
    ...
    fn trim_trailing_api_path_strips_api_v1() {
        assert_eq!(
            trim_trailing_api_path("https://forgejo.example.com/api/v1"),
    ...
    async fn get_current_user_returns_login() {
        ...
        assert_eq!(user.login, "forgejo-user");
    }
