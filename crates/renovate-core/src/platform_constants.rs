...
mod tests {
    ...
    // Ported: "should be part of the GITEA_API_USING_HOST_TYPES" — lib/constants/platform.spec.ts line 23
    #[test]
    ...
    // Ported: "should be part of the FORGEJO_API_USING_HOST_TYPES" — lib/constants/platform.spec.ts line 30
    #[test]
    ...
    // Ported: "should be part of the GITLAB_API_USING_HOST_TYPES" — lib/constants/platform.spec.ts line 42
    #[test]
    ...
    // Ported: "should be not part of the GITLAB_API_USING_HOST_TYPES" — lib/constants/platform.spec.ts line 58
    #[test]
    fn gitlab_api_using_host_types_do_not_include_github() {
        assert!(!GITLAB_API_USING_HOST_TYPES.contains(&"github"));
    }

    // Ported: "should be part of the GITHUB_API_USING_HOST_TYPES" — lib/constants/platform.spec.ts line 62
    #[test]
    ...
    // Ported: "should be not part of the GITHUB_API_USING_HOST_TYPES" — lib/constants/platform.spec.ts line 79
    #[test]
    fn github_api_using_host_types_do_not_include_gitlab() {
        assert!(!GITHUB_API_USING_HOST_TYPES.contains(&"gitlab"));
    }

    // Ported: "should be part of the BITBUCKET_API_USING_HOST_TYPES" — lib/constants/platform.spec.ts line 83
    #[test]
    ...
    // Ported: "should be part of the BITBUCKET_SERVER_API_USING_HOST_TYPES" — lib/constants/platform.spec.ts line 90
    #[test]
