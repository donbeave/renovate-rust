...
mod tests {
    ...
    fn no_duplicate_env_names_across_options() {
        ...
        let names: &[&str] = &[
            "RENOVATE_CONFIG", "RENOVATE_CONFIG_MIGRATION", "RENOVATE_PRINT_CONFIG",
            "RENOVATE_ONBOARDING", "RENOVATE_ONBOARDING_AUTO_CLOSE_AGE",
            "RENOVATE_ONBOARDING_REBASE_CHECKBOX", "RENOVATE_PR_COMMITS_PER_RUN_LIMIT",
            "RENOVATE_ENABLED", "RENOVATE_AUTOMERGE", "RENOVATE_DEPENDENCY_DASHBOARD",
            "RENOVATE_DEPENDENCY_DASHBOARD_APPROVAL", "RENOVATE_DEPENDENCY_DASHBOARD_AUTOCLOSE",
            "RENOVATE_DEPENDENCY_DASHBOARD_TITLE", "RENOVATE_DEPENDENCY_DASHBOARD_HEADER",
            "RENOVATE_DEPENDENCY_DASHBOARD_FOOTER", "RENOVATE_DEPENDENCY_DASHBOARD_LABELS",
            "RENOVATE_CONFIG_WARNING_REUSE_ISSUE", "RENOVATE_LABELS",
            "RENOVATE_TOKEN", "RENOVATE_GIT_PRIVATE_KEY", "RENOVATE_GIT_PRIVATE_KEY_PASSPHRASE",
            "RENOVATE_PLATFORM", "RENOVATE_ENDPOINT", "RENOVATE_USERNAME", "RENOVATE_PASSWORD",
            "RENOVATE_REQUIRE_CONFIG", "RENOVATE_FORK_CREATION", "RENOVATE_FORK_TOKEN",
            "RENOVATE_FORK_ORG", "RENOVATE_DRY_RUN", "RENOVATE_MODE",
            "RENOVATE_ALLOW_COMMAND_TEMPLATING", "RENOVATE_ALLOW_PLUGINS",
            "RENOVATE_ALLOW_SCRIPTS", "RENOVATE_ALLOW_SHELL_EXECUTOR_FOR_POST_UPGRADE_COMMANDS",
            "RENOVATE_OPTIMIZE_FOR_DISABLED", "RENOVATE_ALLOW_CUSTOM_CRATE_REGISTRIES",
            "RENOVATE_ALLOWED_COMMANDS", "RENOVATE_ALLOWED_POST_UPGRADE_COMMANDS",
            "RENOVATE_ALLOWED_HEADERS", "RENOVATE_ALLOWED_ENV",
            "RENOVATE_ALLOWED_UNSAFE_EXECUTIONS", "RENOVATE_EXPOSE_ALL_ENV",
            "RENOVATE_DETECT_GLOBAL_MANAGER_CONFIG", "RENOVATE_DETECT_HOST_RULES_FROM_ENV",
            "RENOVATE_REGISTRY_ALIASES", "RENOVATE_LOCK_FILE_MAINTENANCE",
            "RENOVATE_ONBOARDING_CONFIG", "RENOVATE_RECREATE_CLOSED", "RENOVATE_RECREATE_WHEN",
            "RENOVATE_PLATFORM_AUTOMERGE", "RENOVATE_FORK_PROCESSING",
            "RENOVATE_BINARY_SOURCE", "RENOVATE_PLATFORM_COMMIT",
            "RENOVATE_GIT_URL", "RENOVATE_AUTODISCOVER", "RENOVATE_AUTODISCOVER_FILTER",
            "RENOVATE_AUTODISCOVER_REPO_SORT", "RENOVATE_AUTODISCOVER_REPO_ORDER",
            "RENOVATE_AUTODISCOVER_NAMESPACES", "RENOVATE_AUTODISCOVER_PROJECTS",
            "RENOVATE_AUTODISCOVER_TOPICS", "RENOVATE_DOCKER_MAX_PAGES",
            "RENOVATE_DELETE_CONFIG_FILE", "RENOVATE_DELETE_ADDITIONAL_CONFIG_FILE",
            "RENOVATE_CONFIG_VALIDATION_ERROR", "RENOVATE_CHECKED_BRANCHES",
            "RENOVATE_GIT_NO_VERIFY", "RENOVATE_WRITE_DISCOVERED_REPOS",
            "RENOVATE_S3_ENDPOINT", "RENOVATE_S3_PATH_STYLE",
            "RENOVATE_REPOSITORY_CACHE", "RENOVATE_REPOSITORY_CACHE_TYPE",
            "RENOVATE_REPOSITORY_CACHE_FORCE_LOCAL", "RENOVATE_X_REPO_CACHE_FORCE_LOCAL",
            "RENOVATE_CACHE_HARD_TTL_MINUTES", "RENOVATE_CACHE_PRIVATE_PACKAGES",
            "RENOVATE_PRESET_CACHE_PERSISTENCE", "RENOVATE_INCLUDE_MIRRORS",
            "RENOVATE_GITHUB_TOKEN_WARN", "RENOVATE_ENCRYPTED_WARNING",
            "RENOVATE_IGNORE_PR_AUTHOR", "RENOVATE_BB_USE_DEVELOPMENT_BRANCH",
            "RENOVATE_PR_CACHE_SYNC_MAX_PAGES", "RENOVATE_REPORT_TYPE",
            "RENOVATE_REPORT_PATH", "RENOVATE_REPORT_FORMATTING",
            "RENOVATE_UNICODE_EMOJI", "RENOVATE_USER_AGENT",
            "RENOVATE_BASE_DIR", "RENOVATE_CACHE_DIR", "RENOVATE_LOCAL_DIR",
            "RENOVATE_CONTAINERBASE_DIR", "RENOVATE_DOCKER_CHILD_PREFIX",
            "RENOVATE_DOCKER_CLI_OPTIONS", "RENOVATE_DOCKER_SIDECAR_IMAGE",
            "RENOVATE_DOCKER_USER", "RENOVATE_EXECUTION_TIMEOUT",
            "RENOVATE_GIT_TIMEOUT", "RENOVATE_HTTP_CACHE_TTL_DAYS",
            "RENOVATE_HOST_RULES", "RENOVATE_REPOSITORIES",
            "RENOVATE_MERGE_CONFIDENCE_ENDPOINT", "RENOVATE_MERGE_CONFIDENCE_DATASOURCES",
            "RENOVATE_MERGE_CONFIDENCE_SUPPORTED_DATASOURCES",
            "RENOVATE_MIGRATE_PRESETS", "RENOVATE_CUSTOM_ENV_VARIABLES",
            "RENOVATE_CACHE_TTL_OVERRIDE", "RENOVATE_TOOL_SETTINGS",
            "RENOVATE_ALIASES",
        ];
        ...
        assert!(duplicates.is_empty(), "Duplicate env var names: {:?}", duplicates);
    }
}
